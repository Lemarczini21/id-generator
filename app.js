...
genders = ['M', 'F'];
maleFirstNames = ['John', 'David', 'Michael', 'Robert', 'William'];
femaleFirstNames = ['Emily', 'Emma', 'Olivia', 'Sophia', 'Ava'];
surnames = ['Wood', 'Hearbreaker', 'Bravy', 'Ocean', 'Wayback'];
...
for (let i = 0; i < 20; i++) {
  ...
  const age = Math.floor(Math.random() * (78 - 19) + 18);
